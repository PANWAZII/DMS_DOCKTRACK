...
export const actions = {
  ...
  async acceptDoc({ getters }, data) {
    const headers = getAuthToken(this.$cookies)
    return await axios
      .post('/admins/acceptDoc', data, { headers })
      .then((res) => res)
  },
  ...
  async getAcceptedDoc({ getters }, data) {
    const headers = getAuthToken(this.$cookies)
    return await axios
      .post('/admins/getAcceptedDoc', data, { headers })
      .then((res) => res.data)
  },
  async getDocumentComment({ getters }, data) {
    const headers = getAuthToken(this.$cookies)
    return await axios
      .post('/admins/getDocumentComment', data, { headers })
      .then((res) => res.data)
  },
  async getTechnicalComment({ getters }, data) {
    const headers = getAuthToken(this.$cookies)
    return await axios
      .post('/admins/getTechnicalComment', data, { headers })
      .then((res) => res.data)
  },
  async setDocumentComment({ getters }, data) {
    const headers = getAuthToken(this.$cookies)
    return await axios
      .post('/admins/createDocumentComment', data, { headers })
      .then((res) => res.data)
  },
  async setTechnicalComment({ getters }, data) {
    const headers = getAuthToken(this.$cookies)
    return await axios
